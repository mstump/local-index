...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 5-01-00 | 01 | 0 | WEB-01..06 | — | N/A | compile | `cargo test --test web_dashboard 2>&1 | tail -10` | ✅ W0 | ⬜ pending |
| 5-01-01 | 01 | 1 | WEB-01 | — | N/A | compile | `cargo build 2>&1 | tail -5` | ✅ W0 | ⬜ pending |
...
- [x] `tests/web_dashboard.rs` — stubs for WEB-01 through WEB-06 (created by Plan 01 Task 0)
- [x] `src/web/` module — mod.rs skeleton so compile tests pass (created by Plan 01 Task 1)

*Wave 0 test stubs created in Plan 01 Task 0. All stubs are #[ignore] and compile.*
...
| Index browser shows all files | WEB-03 | DB-dependent rendering | Verify file list shows chunk counts and last-indexed timestamps |
